...
#  geom_hline(yintercept=-1, linetype=2, alpha=0.5) +
#  scale_color_brewer(palette="Set1") +
  scale_color_manual(values=c("#e41a1c", "#01665e", "#477ec8")) +
  scale_linetype_manual(values=c("solid", "41", "3111")) +
  ...
  theme(legend.position=c(0.92, 0.62))
...
#  geom_hline(yintercept=-1, linetype=2, alpha=0.5) +
#  scale_color_brewer(palette="Set1") +
  scale_color_manual(values=c("#e41a1c", "#01665e")) +
  ...
  guides(color=guide_legend(title=NULL, label.position = "bottom", keywidth=unit(2, "lines"), keyheight=unit(0.5, "lines"), label.vjust=2),
         linetype=guide_legend(title=NULL)) +
  theme(legend.position=c(0.94, 0.66))

ggsave("../../../networks/metamapping_paper/figures/cards_results_no_lang.png", width=4, height=3)
```
